...
## Challenge
1. ข้อมูลที่มีแสดงให้เห็นถึงแนวโน้มที่เปลี่ยนแปลงไปในแต่ละช่วงเวลา แต่การหาสาเหตุหรือปัจจัยที่ส่งผลต่อการเปลี่ยนแปลงนั้นต้องหาข้อมูลและข่าวสารเพิ่มเติมเพื่อสนับสนุนและอธิบายผลลัพธ์ให้ชัดเจนยิ่งขึ้น
2. ขั้นตอนการ Cleansing data และรวบรวมข้อมูลจากหลายชุดข้อมูลใช้เวลานาน และต้องทำให้ข้อมูลสมบูรณ์พร้อมใช้งาน
...
4. การทำนายแนวโน้มในอนาคตต้องอาศัยข้อมูลจากหลายด้าน ตัวอย่างเช่น การวิเคราะห์อัตราการตายจากโรคต้องอาศัยข้อมูลทางการแพทย์ ซึ่งทำให้ต้องใช้เวลามากขึ้นในการเก็บรวบรวมข้อมูล
5. เนื่องจากข้อมูลมีความกว้างขวาง ทำให้เกิดไอเดียในการวิเคราะห์ที่หลากหลายจึงทำให้กระบวนการทำงานใช้เวลานานขึ้น
